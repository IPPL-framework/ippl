...
namespace ippl {
    namespace fixDefaultTemplateParam {
        // This namespace is needed to allow for Mesh to have default argument UniformCartesian<T, Dim> via typedef at the end of the file. Compiling for cuda led to error when trying to do so directly...
        /*!
...
namespace ippl {
    ...
    using ParticleSpatialOverlapLayout = fixDefaultTemplateParam::ParticleSpatialOverlapLayout<T, Dim, Mesh,
        PositionProperties...>;
}
