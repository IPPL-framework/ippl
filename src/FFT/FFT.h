...
namespace ippl {
    ...
    */
    template <class Transform, size_t Dim, class T, class Mesh, class Cell>
    class FFT {};
    ...
    */
    ...
    class FFT<CCTransform, Dim, T, Mesh, Cell> {
    public:
        typedef FieldLayout<Dim> Layout_t;
        typedef Kokkos::complex<T> Complex_t;
        typedef Field<Complex_t, Dim, Mesh, Cell> ComplexField_t;
    ...
    */
    template <size_t Dim, class T, class Mesh, class Cell>
    class FFT<RCTransform, Dim, T, Mesh, Cell> {
    public:
        typedef FieldLayout<Dim> Layout_t;
        typedef Field<T, Dim, Mesh, Cell> RealField_t;
    ...
    */
    template <size_t Dim, class T, class Mesh, class Cell>
    class FFT<SineTransform, Dim, T, Mesh, Cell> {
    public:
        typedef FieldLayout<Dim> Layout_t;
        typedef Field<T, Dim, Mesh, Cell> Field_t;
    ...
    */
    template <size_t Dim, class T, class Mesh, class Cell>
    class FFT<CosTransform, Dim, T, Mesh, Cell> {
    public:
        typedef FieldLayout<Dim> Layout_t;
        typedef Field<T, Dim, Mesh, Cell> Field_t;
