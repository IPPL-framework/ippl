...
#define IPPL_SOLVER_OPERATOR_WRAPPER(fun, type) \
    ...
    public:
        ...
        void setSolver(lhs_type lhs) {
            ...
            if (solver_type == "preconditioned") {
                algo_m = std::move(std::make_unique<PCG<OperatorRet, LowerRet , UpperRet, UpperAndLowerRet, InverseDiagonalRet, FieldLHS, FieldRHS>>());
                ...
                algo_m->setPreconditioner(  IPPL_SOLVER_OPERATOR_WRAPPER(-laplace, lhs_type),
                ...
                algo_m = std::move(std::make_unique<CG<OperatorRet, LowerRet , UpperRet, UpperAndLowerRet, InverseDiagonalRet, FieldLHS, FieldRHS>>());
            }
        }
    ...
    protected:
        std::unique_ptr<CG<OperatorRet, LowerRet , UpperRet, UpperAndLowerRet, InverseDiagonalRet, FieldLHS, FieldRHS>> algo_m;
