...
namespace ippl {
    namespace detail {
        ...
        KOKKOS_INLINE_FUNCTION void ZigzagScatterToField(
            ...
            auto _ = (ZigzagScatterToPoint<ScatterPoint>(std::make_index_sequence<Dim>{}, view, wlo,
            ...
            auto __ = (ZigzagScatterToPoint<ScatterPoint>(std::make_index_sequence<Dim>{}, view,
