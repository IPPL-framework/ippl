...
namespace ippl {
    ...
    class TruncatedGreenInteraction : public ParticleInteractionBase<ParticleContainer> /*Energy, Position, Charge/Mass*/ {
    public:
    ...
    public:
        TruncatedGreenInteraction(const ParticleContainer &pc, VectorAttribute &E, const VectorAttribute &R,
