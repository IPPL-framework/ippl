...
/*
    ...
    template <typename E>                                                       \
    struct fun : public detail::FieldExpression<fun<E>> {                       \
        fun(const E& u) : u_m(u) { }                                            \
                                                                                \
    ...
    private:                                                                    \
        const E u_m;                                                            \
                                                                                ...
                                                                                \
    template <typename E,                                                       \
              typename = std::enable_if_t<detail::isFieldExpression<E>::value>> \
    fun<E> name(const detail::FieldExpression<E>& u) {                          \
    ...
    struct fun : public detail::FieldExpression<fun<E1, E2>> {                  \
    ...
    private:                                                                    \
        ...
        const E2 v_m;                                                           \
                                                                                ...
                                                                                \
    template <typename E1, typename E2>                                         \
    fun<E1, E2> name(const detail::FieldExpression<E1>& u,                      \
                     const detail::FieldExpression<E2>& v) {                    \
    ...
    fun<E, detail::Scalar<T>> name(const detail::FieldExpression<E>& u,         \
                                   const T& v) {                                \
    ...
    fun<detail::Scalar<T>, E> name(const T& u,                                  \
                                   const detail::FieldExpression<E>& v) {       \
...
/*
     ...
     */
    template <typename E1, typename E2>
    detail::field_meta_cross<E1, E2> cross(const detail::FieldExpression<E1>& u,
                                           const detail::FieldExpression<E2>& v) {
    ...
    template <typename E1, typename E2>
    detail::field_meta_dot<E1, E2> dot(const detail::FieldExpression<E1>& u,
                                       const detail::FieldExpression<E2>& v) {
