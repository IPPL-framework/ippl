...
KOKKOS_INLINE_FUNCTION
double exact_fct(double x, double y, double z, double density = 1.0, double R = 1.0, double mu = 1.2) {
...
int main(int argc, char *argv[]) {
	...
	ippl::FFTPoissonSolver<ippl::Vector<double,3>, double, 3> FFTsolver(rho, fftParams, "HOCKNEY");
