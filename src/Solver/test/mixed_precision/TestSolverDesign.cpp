...
class TestSolver : public ippl::Electrostatics<float, double, dim, Mesh_t, Centering_t> {
public:
    void solve() override {
...
int main(int argc, char* argv[]) {
    ...
    field_lhs_type lhs(mesh, layout);

    typedef ippl::Field<ippl::Vector<float, dim>, dim, Mesh_t, Centering_t> vfield_type;
