...
namespace ippl {
    namespace random {
        namespace detail {
             ...
             *
             * In particular, find the root x of the equation dist.obj(x, u)= 0 for a given u using
             * Newton-Raphson method.
             *
             * @tparam T Data type for the equation variables.
             * @tparam Distribution Class of target distribution to sample from.
             * @param dist Distribution object providing objective function cdf(x)-u and its
             * derivative.
