...
#ifndef IPPL_LAGRANGESPACEFEMVECTOR_H
#define IPPL_LAGRANGESPACEFEMVECTOR_H
...
namespace ippl {
    ...
    public:
         ...
         */
        LagrangeSpaceFEMVector(UniformCartesian<T, Dim>& mesh, ElementType& ref_element,
         ...
         */
        template <typename F>
        T computeError(const FieldRHS& u_h, const F& u_sol) const;
         ...
         */
        template <typename F>
        T computeErrorInf(const FieldRHS& u_h, const F& u_sol) const;
...
#include "FEM/LagrangeSpaceFEMVector.hpp"
