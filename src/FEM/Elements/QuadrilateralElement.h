...
namespace ippl {
    ...
    public:
        ...
        typedef typename Element2D<T, NumVertices>::mesh_element_vertex_vec_t mesh_element_vertex_vec_t;
        typedef typename Element2D<T, NumVertices>::diag_matrix_vec_t diag_matrix_vec_t;

        mesh_element_vertex_vec_t getLocalVertices() const override;

        diag_matrix_vec_t getTransformationJacobian(
            const mesh_element_vertex_vec_t& global_vertices) const override;
