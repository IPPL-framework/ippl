...
namespace ippl {
    ...
    NonStandardFDTDSolver<EMField, SourceField, boundary_conditions>::NonStandardFDTDSolver(SourceField& source, EMField& E, EMField& B) : FDTDSolverBase<EMField, SourceField, boundary_conditions>(source, E, B) {
    ...
    void NonStandardFDTDSolver<EMField, SourceField, boundary_conditions>::step() {
        ...
        Kokkos::parallel_for(
            ippl::getRangePolicy(aview, nghost),
