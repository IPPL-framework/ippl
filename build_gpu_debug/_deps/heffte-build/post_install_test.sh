...
/p/software/default/stages/2026/software/CMake/4.0.3-GCCcore-14.3.0/bin/cmake \
    ...
    -DCMAKE_CXX_FLAGS="-g" \
    -DHeffte_DIR=/p/home/jusers/mostafa3/juwels/ippl/build_gpu_debug/lib64/cmake/Heffte \
    ...
    -DMPIEXEC_PREFLAGS="" \
    -DMPIEXEC_POSTFLAGS="" \
    /p/home/jusers/mostafa3/juwels/ippl/build_gpu_debug/share/heffte/testing/
