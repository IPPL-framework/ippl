...
# ProjectSetup.cmake
#
# This file is responsible for foundational project settings that apply to
# all targets and builds. It should be included near the top of the top-level
# CMakeLists.txt.
#
# Responsibilities:
...
# use cmake's BUILD_SHARED_LIBS but set IPPL_LIB_TYPE for log purposes
# ------------------------------------------------------------------------------
set(IPPL_LIB_TYPE STATIC)
if (BUILD_SHARED_LIBS)
  set(IPPL_LIB_TYPE SHARED)
endif()
message(STATUS "🔧 IPPL will be built as a ${IPPL_LIB_TYPE} library")
...
if(NOT CMAKE_BUILD_TYPE AND NOT CMAKE_CONFIGURATION_TYPES)
    ...
    set(CMAKE_BUILD_TYPE "${default_build_type}" CACHE STRING
        "Choose the type of build (${_allowed_build_types})" FORCE)
