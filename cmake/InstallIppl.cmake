...
if(TARGET finufft)
  install(TARGETS finufft EXPORT ipplTargets DESTINATION lib)
endif()
if(TARGET cufinufft)
  install(TARGETS cufinufft EXPORT ipplTargets DESTINATION lib)
endif()
if(TARGET kokkos_nufft)
  install(TARGETS kokkos_nufft fft common EXPORT ipplTargets DESTINATION lib)
endif()
