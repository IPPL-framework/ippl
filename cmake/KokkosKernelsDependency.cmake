...
if(NOT TARGET Kokkos::kokkoskernels)
  ...
  if(IPPL_KOKKOS_KERNELS_HOST STREQUAL "LAPACKE")
    ...
    if(LAPACKE_LIBRARIES)
      ...
      if(IPPL_LAPACKE_INCLUDE_DIR AND IPPL_LAPACKE_LIBRARY AND LAPACK_FOUND)
        set(LAPACKE_INCLUDE_DIRS "${IPPL_LAPACKE_INCLUDE_DIR}")
        set(LAPACKE_LIBRARIES "${IPPL_LAPACKE_LIBRARY};${LAPACK_LIBRARIES}")
      elseif(IPPL_FETCH_LAPACKE)
  ...
  foreach(_variable LAPACKE_INCLUDE_DIRS LAPACKE_LIBRARIES)
    ...
    set(${_variable} "${${_variable}}" CACHE STRING "Host LAPACKE dependency" FORCE)
  endforeach()
  FetchContent_MakeAvailable(KokkosKernels)
  foreach(_variable LAPACKE_INCLUDE_DIRS LAPACKE_LIBRARIES)
    if(_had${_variable})
      set(${_variable} "${_saved${_variable}}" CACHE STRING "Host LAPACKE dependency" FORCE)
    else()
