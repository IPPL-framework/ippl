...
int main(int argc, char* argv[]){
    ippl::initialize(argc, argv);
    {
        ...
        // Run the simulation for a duration of 1, with periodic boundary conditions the wave will return to the initial state
        ...
        std::cout << "Sum after evaluating boundaryconditions: " << sum_error / double(nr[0] * nr[1] * nr[2]) << "\n";
