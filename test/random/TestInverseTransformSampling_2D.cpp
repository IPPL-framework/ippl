...
int main(int argc, char* argv[]) {
    ippl::initialize(argc, argv);
    {
        ...
        */
        ...
        // example of sampling normal in one and harmonic in another with custom functors
        const int DimP = 4;
        ...
        const double parH[DimP] = {1.0, 0.5, 0.5, 2.*pi/(rmax[1]-rmin[1])*4.0};
        DistH_t distH(parH);
        samplingH_t samplingH(distH, rmax, rmin, rlayout, ntotal);
        unsigned int nlocal = samplingH.getLocalNum();
