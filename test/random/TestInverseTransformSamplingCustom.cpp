...
double get_harm_dist_cent_mom(double a, double b, double r, int i) {
    ...
    if (i == 2)
        return ((2.
                 * ((3. * a * b * b * r * r - 6. * a) * sin(b * r) + 6. * a * b * r * cos(b * r)
                    + pow(b * r, 3.)))
                / (3. * pow(b, 3.)))
               / Z;
    if (i == 4)
        return ((2. * a * (b * b * r * r * (b * b * r * r - 12.) + 24.) * sin(b * r)) / pow(b, 5.)
                + (8. * a * r * (b * b * r * r - 6.) * cos(b * r)) / pow(b, 4.)
                + (2. * pow(r, 5.)) / 5.)
               / Z;
    if (i == 6)
        return ((2. * a * (b * b * r * r * (b * b * r * r * (b * b * r * r - 30.) + 360.) - 720.)
                 * sin(b * r))
                    / pow(b, 7)
                + (12. * a * r * (b * b * r * r * (b * b * r * r - 20.) + 120.) * cos(b * r))
                      / pow(b, 6)
                + (2. * pow(r, 7)) / 7.)
               / Z;
    return 0;
