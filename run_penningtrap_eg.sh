...
echo "Using PareView at at: ${PV_PREFIX}"
...
# export MPIEXEC=/home/klappi/AddApp/paraview_versions/ParaView-5.12.0-MPI-Linux-Python3.10-x86_64/lib/mpiexec
# exec $MPIEXEC -np 1 
# ./PenningTrap 4 4 4 512 30 FFT 0.05 LeapFrog --overallocate 1.0 --pvscript $PVSCRIPT --pvproxy  $PVPROXY --info 5
